...
class mainn:
    def __init__(self, root):
        ...
        btn1_1 = Button(Frame1, text="Student Management", command=self.student_details, cursor="hand2", font=("times new roman", 15, "bold",),bg="#063970", fg="white",width="15")
        btn1_1.grid(row=1, column=1,pady=0)

        def on_leave(e):
            btn1_1.config(background= '#063970', foreground= 'white')
        def on_enter(e):
            btn1_1.config(background='white', foreground= "#063970")
        ...
        btn5 = Button(Frame1, image=self.photoimg9,command=self.train, cursor="hand2",width=150,height=150)
        btn5.grid(row=0, column=2,padx=10)

        btn5_5 = Button(Frame1, text="Train Data",command=self.train, cursor="hand2", font=("times new roman", 15, "bold"),width="12",
                        bg="#063970", fg="white")
        btn5_5.grid(row=1, column=2)
        
        def on_leave(e):
            btn5_5.config(background= '#063970', foreground= 'white')
        def on_enter(e):
            btn5_5.config(background='white', foreground= "#063970")
        ...
        btn2.grid(row=0, column=3,padx=10,pady=5)

        btn2_2 = Button(Frame1, text="Tak Attendance",command=self.face_recognition, cursor="hand2", font=("times new roman", 15, "bold"), bg="#063970", fg="white",width="12")
        btn2_2.grid(row=1, column=3)

        def on_leave(e):
            btn2_2.config(background= '#063970', foreground= 'white')
        def on_enter(e):
            btn2_2.config(background='white', foreground= "#063970")
        ...
        # Rabort button
        img7 = Image.open("Images/report.png")
        ...
        btn3.grid(row=0, column=4,padx=10)

        btn3_3 = Button(Frame1, text="Rabort",command=self.attendance, cursor="hand2", font=("times new roman", 15, "bold"),bg="#063970", fg="white",width="12")
        btn3_3.grid(row=1, column=4)
        
        def on_leave(e):
            btn3_3.config(background= '#063970', foreground= 'white')
        def on_enter(e):
            btn3_3.config(background='white', foreground= "#063970")
        ...
        # dashboard
        img8 = Image.open("Images/helpdesk.jpg")
        ...
        btn4.grid(row=0, column=5,padx=10)

        btn4_4 = Button(Frame1, text="Dashboard",command=self.dashboard, cursor="hand2", font=("times new roman", 15, "bold"),bg="#063970", fg="white",width="12")
        btn4_4.grid(row=1, column=5)
        
        def on_leave(e):
            btn4_4.config(background= '#063970', foreground= 'white')
        def on_enter(e):
            btn4_4.config(background='white', foreground= "#063970")
        ...
        btn6_6 = Button(Frame1, text="Photos",command=self.open_img, cursor="hand2", font=("times new roman", 15, "bold"),bg="#063970", fg="white",width="12")
        btn6_6.grid(row=1, column=6)
        
        def on_leave(e):
            btn6_6.config(background= '#063970', foreground= 'white')
        def on_enter(e):
            btn6_6.config(background='white', foreground= "#063970")
        ...
        btn7_7 = Button(Frame1, text="About Us",command=self.about, cursor="hand2", font=("times new roman", 15, "bold"), bg="#063970", fg="white",width="12")
        btn7_7.grid(row=1, column=7)
        
        def on_leave(e):
            btn7_7.config(background= '#063970', foreground= 'white')
        def on_enter(e):
            btn7_7.config(background='white', foreground= "#063970")
        ...
        btn8_8 = Button(Frame1, text="Exit",cursor="hand2",command=self.exit,  font=("times new roman", 15, "bold"),  bg="#063970", fg="white",width="12")    
        btn8_8.grid(row=1, column=8,padx=20)
        
        def on_leave(e):
            btn8_8.config(background= '#063970', foreground= 'white')
        def on_enter(e):
            btn8_8.config(background='white', foreground= "red")
